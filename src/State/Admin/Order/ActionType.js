...
export const DELIVERING_ORDER_REQUEST = "DELIVERING_ORDER_REQUEST";
export const DELIVERING_ORDER_SUCCESS = "DELIVERING_ORDER_SUCCESS";
export const DELIVERING_ORDER_FAILURE = "DELIVERING_ORDER_FAILURE";
