...
const AddCategoryForm = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const formattedData = {
      ...
      topLevelCategoryLevel: categoryData.topLevelCategoryLevel,
      secondLevelSectionLevel: categoryData.secondLevelSectionLevel,
      thirdLevelItemLevel: categoryData.thirdLevelItemLevel,
    };
