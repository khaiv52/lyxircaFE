...
const TopLevelCategoryEdit = () => {
  ...
  return (
    <div className="p-10">
      ...
      <form onSubmit={handleSubmit} className="min-h-screen w-[350px] sm:w-[350px] lg:w-[400px]">
        <Grid container spacing={2} columnSpacing={{ xs: 1, sm: 2, md: 3 }} justifyContent="Center">
