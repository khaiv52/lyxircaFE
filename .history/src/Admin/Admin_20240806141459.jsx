  ...
  <div className="relative flex flex-col">
    ...
    <div className="content">
      <Routes>
        ...
        <Route path="/update-top-level" element={<TopLevelCategoryEdit />} />
        <Route path="/update-second-level" element={<SecondLevelCategoryEdit />} />
        <Route path="/update-third-level" element={<ThirdLevelCategoryEdit />} />
      </Routes>
    </div>
  </div>
</Suspense>
