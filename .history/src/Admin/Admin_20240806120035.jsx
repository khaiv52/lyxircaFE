...
const TopLevelCategoryEdit = lazy(() =>
  import("../Admin/components/Category/TopLevelCategoryEdit")
);
...
const ThirdLevelCategoryEdit = lazy(() =>
  import("../Admin/components/Category/ ")
);
      ...
      <div className="relative flex flex-col">
        ...
        <div className="content">
          <Routes>
            ...
            <Route path="/categories/add" element={<CategoryForm />}></Route>
            <Route path="/categories" element={<CategoryTable />}></Route>

            {/* Category Edit Routes */}
            <Route
              path="/update-top-level/:id"
              element={<TopLevelCategoryEdit />}
            />
            <Route
              path="/update-second-level/:id"
              element={<SecondLevelCategoryEdit />}
            />
            <Route
              path="/update-third-level/:id"
